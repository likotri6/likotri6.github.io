	...
	if (cookieObj.get('pg') == 'daily')
	{
		...
		async function asyncWait() 
		{
			...
			setTimeout(function () {				
				...
				$('body').append('<div id="page"> <div class="hamburger-menu"> <input id="menu__toggle" type="checkbox" /> <label class="menu__btn" for="menu__toggle"> <span></span> </label> <ul class="menu__box"> <li><a class="menu__item" href="/pages/home/">Home</a></li> <li><a class="menu__item" href="/pages/about.html">About Us</a></li> <li><a class="menu__item" href="/pages/privacy.html">Privacy Policy</a></li> <li><a class="menu__item" href="/pages/disclaimer.html">Disclaimer</a></li> <li><a class="menu__item" href="/pages/contact.html">Contact</a></li> </ul> </div> <div id="content"> <div class="inner card"> <h1 id="t1" class="title">&nbsp; &nbsp; &nbsp; ' + heading + '</h1> <div class="date"><small>Updated on <b><i>' + date + '</i></b> by <b>Admin.</b></small></div> <div id="content-image"> <img class="main-image" src="https://i0.wp.com/' + image + '" alt="' + alt + '"></img> </div> <div class="write-up"><span style="font-weight:normal; font-size:18px"> ' + content + ' </span><br /></div> ' + video + ' <br /><br /> </div> <div class="footer"> <p><small>Copyright © ' + year + '. All Rights Reserved.</small></p> <br /><br /> </div> </div> </div>');
			}, 1000);
		}
